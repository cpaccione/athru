...
function athrupartners_scripts() {
	...
	wp_enqueue_style ('tailwind', get_template_directory_uri() . '/css/tailwind.css', array(), '0.0.2', 'all' );
	wp_enqueue_style ('main-style', get_template_directory_uri() . '/css/main.css', array(), '3.1', 'all' );
